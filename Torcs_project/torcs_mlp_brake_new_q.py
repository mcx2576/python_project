...
val_data_filenames = ['val_data1.csv','val_data2.csv','train_data4.csv','train_data5.csv','train_data6.csv','train_data7.csv','train_data8.csv']#['data_track1.csv', 'data_track2.csv']
...
torch.save(torcs_NN_acc.state_dict(), "torcs_NN_trained_brake_new_q")

#
torcs_NN_acc2 = torcs_mlp_NN_acc(num_features, num_nodes_hidden, num_output)
torcs_NN_acc2.load_state_dict(torch.load("torcs_NN_trained_brake_new_q"))
